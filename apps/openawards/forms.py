...
class WorkForm(forms.ModelForm):
    ...
    authorship = forms.ChoiceField(choices=Meta.model.AUTHORSHIP_CHOICES, widget=forms.RadioSelect())
...
class ClaimAuthorshipForm(forms.Form):
    name = forms.CharField(required=True, max_length=100)
    email = forms.EmailField(label="e-mail", required=True, max_length=150)
    message = forms.CharField(widget=forms.Textarea)


class ExchangeCouponForm(forms.Form):
